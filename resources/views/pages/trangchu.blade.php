    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-6 pt-4 pt-lg-0 order-2 order-lg-1 d-flex flex-column justify-content-center">
          <h1>{{$thongtincty->ten_cty}}</h1>
          <h2>{{$thongtincty->mo_ta}}</h2>
          <div><a href="#about" class="btn-get-started scrollto">Giới thiệu</a></div>
        </div>
        <div class="col-lg-6 order-1 order-lg-2 hero-img">
          <img src="upload/plastic-energy.jpg" class="img-fluid" alt="">
        </div>
      </div>
    </div>
  ...
  <main id="main">
    ...
    <section id="counts" class="counts">
      <div class="container">
        ...
        <div class="text-center title">
          <h3>Những thành tựu chúng tôi đạt được</h3>
        ...
        <div class="row counters position-relative">
          ...
          <div class="col-lg-3 col-6 text-center">
            <span data-purecounter-start="0" data-purecounter-end="140863" data-purecounter-duration="1" class="purecounter"></span>
            <p>Giờ làm việc</p>
          </div>
    ...
    <section id="contact" class="contact">
      <div class="container">
        ...
        <div class="section-title">
          <h2>Liên hệ</h2>
          <p>Nếu có bất kỳ thắc mắc về sản phẩm và dịch vụ của chúng tôi, cần hợp tác công việc, hãy liên hệ với chúng tôi.</p>
        </div>

        <div>
          <iframe style="border:0; width: 100%; height: 270px;" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d5574.7885466464195!2d106.13601195786111!3d21.163338918971913!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x31350b5f62083171%3A0x12839c16824a67be!2zSMOgIExp4buFdSwgUGjGsMahbmcgTGnhu4V1LCBRdeG6vyBWw7UsIELhuq9jIE5pbmgsIFZp4buHdCBOYW0!5e0!3m2!1svi!2s!4v1655742889649!5m2!1svi!2s" frameborder="0" allowfullscreen></iframe>
        </div>
          ...
          <div class="col-lg-4">
            <div class="info">
              <div class="address">
                ...
                <h4>Địa chỉ:</h4>
                <p>{{$thongtincty->dia_chi}}</p>
              </div>

              <div class="email">
                <i class="bi bi-envelope"></i>
                <h4>Email:</h4>
                <p>{{$thongtincty->email}}</p>
              </div>
